...
@Component
@Scope("prototype")
public class SecBuyListTag extends BaseFreeMarkerTag {
	...
	protected Object exec(Map params) throws TemplateModelException {
		...
		String sort_type_str=request.getParameter("sort_type")==null||request.getParameter("sort_type").equals("")?"1":request.getParameter("sort_type");	//秒拍类型 0.往期秒拍.1.当前秒拍.2.之后的秒拍
		...
		Page page=this.secBuyManager.search(this.getPage(), this.getPageSize(), catid, minprice, maxprice, sort_key, sort_type,area_id, area_id);
