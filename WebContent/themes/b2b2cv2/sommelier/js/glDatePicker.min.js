...
y=y(0,6,b.selectableDOW),z=b.dowNames||"日 一 二 三 四 五 六".split(" "),t=b.monthNames||"01月 02月 03月 04月 05月 06月 07月 08月 09月 10月 11月 12月".split(" "),f=d.outerWidth(),e,k=f/7+6*(b.borderSize/7),f=f/8+7*(b.borderSize/8);c.length?eval(c.data("is"))||(f=c.outerWidth(),e=c.outerHeight(),k=f/7+6*(b.borderSize/7),f=e/8+7*(b.borderSize/8)):(g.calendar=c=$("<div/>").attr("gldp-el",d.attr("gldp-id")).data("is",!0).css({display:b.showAlways?void 0:"none",zIndex:b.zIndex,
