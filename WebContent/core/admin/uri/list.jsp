...
<div class="grid">
	...
	<grid:grid  from="uriList">
	  ...
	  <grid:body item="uri">
	        ...
	        <grid:cell>${uri.httpcache}
	        <input type="radio" name="httpcache_${uri.id}" value="1" <c:if test="${uri.httpcache==1}" >checked="checked"</c:if> />是&nbsp;&nbsp;
	        <input type="radio" name="httpcache_${uri.id}" value="0" <c:if test="${uri.httpcache==0}" >checked</c:if> />否
	         </grid:cell>
