...
<table  class="form-table">
	<tr>
		...
		<td>
		<input type="password" name="oldpassword" id="oldpassword"  dataType="string" isrequired="true" style="width:260px;" />
		</td>
	</tr>
	<tr height="30px">
	...
	<tr>
		...
		<td>
			<input type="password" name="newpassword" id="newpassword" dataType="string" isrequired="true" fun="checkPassword" style="width:260px;" />
		</td>
	</tr>
