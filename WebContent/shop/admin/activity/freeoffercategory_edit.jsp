 ...
 <input type="hidden" name="freeOfferCategory.cat_id" value="${freeOfferCategory.cat_id }" />
   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
     <tr>
       ...
       <td  ><input type="text" name="freeOfferCategory.cat_name" maxlength="60" value="${freeOfferCategory.cat_name }"  dataType="string" isrequired="true" />       </td>
      </tr>
	<tr>
      ...
      <tr>
       <th>排序：</th>
       <td  ><input type="text" name="freeOfferCategory.sorder" maxlength="60" value="${freeOfferCategory.sorder }"  dataType="int" isrequired="true" /></td>
      </tr>
   </table>
