 ...
 <form class="validate" method="post" action="freeOfferCategory!save.do" name="theForm" id="theForm">
   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
     <tr>
       ...
       <td  ><input type="text" name="freeOfferCategory.cat_name" maxlength="60" value=""  dataType="string" isrequired="true" />       </td>
      </tr>
	<tr>
      ...
      <tr>
       ...
       <td  ><input type="text" name="freeOfferCategory.sorder" maxlength="60" value=""  dataType="int" isrequired="true" /></td>
      </tr>
   </table>
