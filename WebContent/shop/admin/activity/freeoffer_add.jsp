 ...
 <form class="validate" method="post" action="freeOffer!save.do" name="theForm" id="theForm" enctype="multipart/form-data">
   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
     <tr>
       ...
       <td><input type="text" name="freeOffer.fo_name" maxlength="60" value=""  dataType="string" isrequired="true" />       </td>
      </tr>
      <tr>
	...
	<tr>
       ...
       <td  ><input type="text" name="mstartdate" maxlength="60" value=""  dataType="date" isrequired="true" class="dateinput"/></td>
      </tr>
      <tr>
       <th><label class="text">终止时间：</label></th>
       <td  ><input type="text" name="menddate" maxlength="60" value=""  dataType="date" isrequired="true" class="dateinput"/></td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td  ><input type="text" name="freeOffer.limit_purchases" maxlength="60" id="limit_purchases" isrequired="true"  dataType="int"  fun="chknum"/></td>
      </tr>      
      <tr>
       <th><label class="text">价格：</label></th>
       <td  ><input type="text" name="freeOffer.price" maxlength="60" value="" isrequired="true"   dataType="float"  /></td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td  ><input type="text" name="freeOffer.score" maxlength="60"  isrequired="true"   dataType="float"  /></td>
      </tr>
      <tr>
       <th><label class="text">重量：</label></th>
       <td  ><input type="text" name="freeOffer.weight" maxlength="60"  isrequired="true"  dataType="float"  /></td>
      </tr>
      <tr>
       <th><label class="text">库存：</label></th>
       <td  ><input type="text" name="freeOffer.repertory" maxlength="60"  isrequired="true"   dataType="int" /></td>
      </tr>
	<tr>
