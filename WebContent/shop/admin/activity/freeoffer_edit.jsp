  ...
  <input type="hidden" name="oldpic" value="${freeOffer.pic }" />
   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
     <tr>
       ...
       <td  ><input type="text" name="freeOffer.fo_name" maxlength="60" value="${freeOffer.fo_name }"  dataType="string" isrequired="true" />       </td>
      </tr>
      <tr>
	...
	<tr>
       ...
       <td  ><input type="text" name="mstartdate" maxlength="60" value="<html:dateformat pattern="yyyy-MM-dd" time="${freeOffer.startdate }"></html:dateformat>"  dataType="date" isrequired="true" class="dateinput"/></td>
      </tr>
      <tr>
       <th><label class="text">终止时间：</label></th>
       <td  ><input type="text" name="menddate" maxlength="60" value="<html:dateformat pattern="yyyy-MM-dd" time="${freeOffer.enddate }"></html:dateformat>"  dataType="date" isrequired="true" class="dateinput"/></td>
      </tr>
      <tr>
       <th><label class="text">允许兑换<br/>的会员等级：</label></th>
       <td  >
<!--       <input type="text" name="freeOffer.lv_ids" id="freeOffer_lv_ids" maxlength="60" value="${freeOffer.lv_ids }"  dataType="string" isrequired="true" />-->
      ...
      <tr>
       ...
       <td><input type="text" name="freeOffer.limit_purchases" maxlength="60" id="limit_purchases" value="${freeOffer.limit_purchases }" isrequired="true"  dataType="int" fun="chknum" /></td>
      </tr>      
      <tr>      
      <tr>
       <th><label class="text">价格：</label></th>
       <td  ><input type="text" name="freeOffer.price" maxlength="60" value="${freeOffer.price }" isrequired="true"   dataType="float"  /></td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td  ><input type="text" name="freeOffer.score" maxlength="60" value="${freeOffer.score }" isrequired="true"  dataType="float"  /></td>
      </tr>
      <tr>
       <th><label class="text">重量：</label></th>
       <td  ><input type="text" name="freeOffer.weight" maxlength="60" value="${freeOffer.weight }" isrequired="true"   dataType="float"  /></td>
      </tr>
      <tr>
       <th><label class="text">库存：</label></th>
       <td  ><input type="text" name="freeOffer.repertory" maxlength="60" value="${freeOffer.repertory }" isrequired="true"  dataType="int"  /></td>
      </tr>
	<tr>
