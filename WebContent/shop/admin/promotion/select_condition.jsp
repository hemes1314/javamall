...
<table class="form-table"  cellspacing="0" cellpadding="0" border="0" width="100%">
	<tbody>
		...
		<tr>
			<th>订单优惠条件：</th>
			<td><input type="text" value="${money_from }"   isrequired="true" dataType="float" size="10" name="money_from" autocomplete="off"><b>≤</b>订单金额 ＜
...
<table class="form-table"  cellspacing="0" cellpadding="0" border="0" width="100%">
	<tbody>
		...
		<tr>
			<th>活动规则开始时间:</th>
			<td>
			<input type="text"   readonly dataType="date" isrequired="true" class="dateinput" value="<fmt:formatDate value="${time_begin}" pattern="yyyy-MM-dd"/>" name="time_begin" autocomplete="off">
			</td>
		</tr>
		<tr>
			<th>活动规则结束时间:</th>
			<td>
			<input type="text"  readonly dataType="date" isrequired="true" class="dateinput"   value="<fmt:formatDate value="${time_end}" pattern="yyyy-MM-dd"/>" name="time_end" autocomplete="off">
			</td>
		</tr>
	</tbody>
</table>
...
<div class="tableform">
<h4>规则描述</h4>
<textarea vtype="textarea" style="" isrequired="true" rows="6" cols="60" name="describe" type="textarea">${ describe}</textarea>
<br>
