...
<table cellspacing="0" cellpadding="0" border="0" width="100%"
	...
	<tr>
		...
		<td><input type="text" isrequired="true" name="bind.name"></td>
	</tr>
</table>
<table cellspacing="0" cellpadding="0" border="0" width="100%"
	class="form-table">
	...
	<tr>
		...
		<td><input type="text"  isrequired="true" name="bind.store"dataType="int" ></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text"   isrequired="true" dataType="float"  name="bind.price">
		</td>
	</tr>
</table>
<div class="division">
