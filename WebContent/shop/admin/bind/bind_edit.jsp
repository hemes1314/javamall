...
<table cellspacing="0" cellpadding="0" border="0" width="100%"
	...
	<tr>
		...
		<td><input type="text" isrequired="true" name="bind.name" value="${bind.name }"></td>
	</tr>
</table>
<table cellspacing="0" cellpadding="0" border="0" width="100%"
	class="form-table">
	...
	<tr>
		...
		<td><input type="text"  isrequired="true" dataType="int" name="bind.store" value="${bind.store }"></td>
	</tr>
	<tr>
