package com.enation.app.b2b2cGroupbuy.core.service;
...
public class StoreGroupBuyManager implements IStoreGroupBuyManager {
	...
	public StoreGroupBuy getBuyGoodsId(int goodsId,int act_id) {
		String sql="SELECT * from es_groupbuy_goods WHERE goods_id=? and act_id=? AND ROWNUM<=1";
		StoreGroupBuy groupBuy= (StoreGroupBuy)this.daoSupport.queryForObject(sql, StoreGroupBuy.class, goodsId,act_id);
	...
	public StoreGroupBuy get(int gbid) {
		...
		StoreGroupBuy groupBuy= (StoreGroupBuy)this.daoSupport.queryForObject(sql, StoreGroupBuy.class,gbid);
