...
//		//System.out.println(md5.getMD5("123456".getBytes()) );
	...
	public static String getRootPath() {
		...
		//System.out.println("getRoot path original is "+filePath );
		...
		if (System.getProperty("os.name").toLowerCase().indexOf("window") < 0 && !filePath.startsWith("/")) {
			filePath = "/" + filePath;
		}

		if (filePath.endsWith("/"))
			filePath = filePath.substring(0, filePath.length() - 1);
		//System.out.println("getRoot path final is "+filePath );
		return filePath;
	}
	...
	public static String getFileSize(String fileSize) {
		...
		double dbFileSize = NumberUtils.toDouble(fileSize);
		if (dbFileSize >= 1024) {
