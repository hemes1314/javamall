 ...
 *2015-3-29
 */
public class FlashBuyActive {
	private int act_id; //活动Id
	private String act_name;	//活动名称
	private long start_time;	//活动开启时间
	private long end_time;		//限时抢购结束时间
	private int act_status; 	//0.未开始.1.已开始.2.已结束
	private long add_time;		//限时抢购添加时间
	private int act_tag_id;		//限时抢购活动标签Id
	private long join_end_time; //限时抢购报名截止时间
