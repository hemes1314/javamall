...
/**
 * 
 * @ClassName: FlashBuyListTag 
 * @Description:  限时抢购列表标签 
 * @author TALON 
...
@Component
@Scope("prototype")
public class FlashBuyListTag extends BaseFreeMarkerTag {
	 ...
	 * @param maxprice 最大价格
	 * @param sort_key 排序类型
	 * @param sort_type 限时抢购类型
	 * @param area_id 地区Id
	 * @param page 限时抢购商品分页列表
	 */
	@Override
	protected Object exec(Map params) throws TemplateModelException {
		...
		String sort_type_str=request.getParameter("sort_type")==null||request.getParameter("sort_type").equals("")?"1":request.getParameter("sort_type");	//限时抢购类型 0.往期限时抢购.1.当前限时抢购.2.之后的限时抢购
		...
		Page page=this.flashBuyManager.search(this.getPage(), this.getPageSize(), catid, minprice, maxprice, sort_key, sort_type,area_id, area_id);
