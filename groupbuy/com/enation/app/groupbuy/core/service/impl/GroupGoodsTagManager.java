...
public class GroupGoodsTagManager implements IGroupGoodsTagManager{
	...
	public List listGoods(String catid, String tagid, String goodsnum) {
		...
		sql.append("select g.*,gb.price as gb_price,gb.original_price as original_price,gb.gb_title as gb_title from es_tag_rel r LEFT JOIN es_goods g ON g.goods_id=r.rel_id INNER JOIN es_groupbuy_goods gb ON gb.goods_id=g.goods_id where gb.gb_status=1 and g.disabled=0 and g.market_enable=1");
