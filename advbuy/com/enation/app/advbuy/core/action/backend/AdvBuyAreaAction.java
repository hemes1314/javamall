...
/**
 * 
 * @ClassName: AdvBuyAreaAction 
 * @Description: 预售地区管理action 
 * @author TALON 
...
@Results({
	 @Result(name="list",type="freemarker", location="/advbuy/area/area_list.html"),
	 @Result(name="add",type="freemarker", location="/advbuy/area/area_add.html"),
	 @Result(name="edit",type="freemarker", location="/advbuy/area/area_edit.html")
})

@Action("advBuyArea")
public class AdvBuyAreaAction extends WWAction {
	...
	/**
	 * 预售地区分页列表json
	 * @param webpage 预售地区分页
	 * @return
	 */
	public String list_json(){
		this.webpage=this.advBuyAreaManager.list(this.getPage(),this.getPageSize());
	...
	public String saveAdd(){
		try {
			AdvBuyArea advBuyArea = new AdvBuyArea();
			advBuyArea.setArea_name(area_name);
			advBuyArea.setArea_order(area_order);
			this.advBuyAreaManager.add(advBuyArea);
	 ...
	 * 跳转至修改预售地区
	 * @param advBuyArea 预售地区
	 * @param area_id 预售地区Id数组
	 * @return
	 */
	public String edit(){
		this.advBuyArea = this.advBuyAreaManager.get(area_id[0]);
		return "edit";
	}
	/**
	 * 
	 * @Title: saveEdit
	 * @Description: 保存修改预售地区
	 * @param advBuyArea 预售地区
	 * @param area_id 预售地区Id数组
	 * @param area_name 地区名称
	 * @param area_order 预售地区排序
	 * @return json 1为成功.0为失败
	 */
	public String saveEdit(){
		try {
			AdvBuyArea advBuyArea = new AdvBuyArea();
			advBuyArea.setArea_id(area_id[0]);
			advBuyArea.setArea_name(area_name);
			advBuyArea.setArea_order(area_order);
			this.advBuyAreaManager.update(advBuyArea);
	...
	public String batchDelete(){
		try {
			this.advBuyAreaManager.delete(area_id);
	...
	public AdvBuyArea getAdvBuyArea() {
		return advBuyArea;
	}


	public void setAdvBuyArea(AdvBuyArea advBuyArea) {
		this.advBuyArea = advBuyArea;
	}
