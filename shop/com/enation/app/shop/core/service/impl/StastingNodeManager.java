...
public class StastingNodeManager extends BaseSupport<TastingNote> {

    public void stastingNodeManager() {
    ...
    public TastingNote get(Integer id) {
	        if(id!=null&&id!=0){
	            ...
	            TastingNote tastingNote = this.baseDaoSupport.queryForObject(sql, Sommelier.class,id);
	            return tastingNote;
	        }else{
	            return null;
	        }
