...
public class CostDownActive {
	...
	public String getJoin_end_time_str() {
        return  DateUtil.toString(join_end_time, "yyyy-MM-dd HH:mm:ss");
    }
	...
	public String getStart_time_str() {
		...
		return  DateUtil.toString(start_time, "yyyy-MM-dd HH:mm:ss");
	}
	...
	public String getEnd_time_str() {
		return  DateUtil.toString(end_time, "yyyy-MM-dd HH:mm:ss");
	}
